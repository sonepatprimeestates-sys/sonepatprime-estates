...
const PHONE_NUMBER = "9050501099"; // replace with your real number
      ...
      container.innerHTML += `
        <div class="property-card">
          ...
          <div class="actions">
            ...
            <a href="https://wa.me/${PHONE_NUMBER}?text=Hi,%20I%20am%20interested%20in%20${encodeURIComponent(item.title)}">
              💬 WhatsApp
            </a>
          </div>
        </div>
